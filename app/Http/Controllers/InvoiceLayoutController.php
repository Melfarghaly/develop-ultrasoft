...
class InvoiceLayoutController extends Controller
{
    ...
    private function getDesigns()
    {
        return ['classic' => __('lang_v1.classic').' ('.__('lang_v1.for_normal_printer').')',
            ...
            'classic_leon'=>'شركة ليون',
            'raidi' => 'raidi',

            'letterhead' => 'Letterhead',
            'classic_reapir' => 'فاتورة صيانة',
            'classic_abdallah'=>'عبدالله السعودية',
            'slim_table'=>'ريسيت - جدول',
            'abdoksa' => 'عبدو السعودية',
            'sdeak_steel'   => 'الصديق استيل ',
            'abdoksa_no_prices' => ' فاتورة بدون اسعار',
        ];
    }
}
