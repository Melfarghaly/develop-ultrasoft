...
@section('title', __('القيد الافتتاحي'))
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::hidden('type', 'opening_journal_entry', ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped hide-footer" id="journal_table">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-1">@lang( 'accounting::lang.cost_center' )</th>
                ...
                <tbody>
                    @for($i = 1; $i <= 10; $i++)
                        <tr>
                            ...
                            <td>
                                {!! Form::select('cost_center_id[' . $i . ']', [], null, 
