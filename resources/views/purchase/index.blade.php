...
@endphp
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <input type="text" name="sub_type" id="sub_type" value="{{request()->type ?? 'purchase' }}">
            <div class="col-md-3">
                <div class="form-group">
        ...
        @endcomponent
@if($type=='permission')
        @component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.permission')])
            @can('purchase.create')
                @slot('tool')
                    <div class="box-tools">
                    ...
                    <i class="fa fa-plus"></i> @lang('messages.add')</a> --}}
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                            href="{{action([\App\Http\Controllers\PurchaseController::class, 'create'],['type'=>'permission'])}}">
