...
function set_default_payment_account() {
    ...
    if(payment_type=='cash'){
        $('#transaction_payment_add_form .cash-account-selection').show();
        $('#transaction_payment_add_form .bank-selection').hide();
    } else if (['card', 'bank_transfer', 'cheque'].includes(payment_type)) {
        $('#transaction_payment_add_form .cash-account-selection').hide();
        $('#transaction_payment_add_form .bank-selection').show();
    }
