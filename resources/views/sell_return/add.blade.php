	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							$cost_center_id = !empty($sell->return_parent->cost_center_id) ? $sell->return_parent->cost_center_id : '';
							@endphp
				...
				<div class="col-sm-3">
					@includeIf('cost_center.costCenter', [ 'selected_cost_center' =>$cost_center_id])
				</div>
				<div class="col-sm-12">
					<table class="table bg-gray" id="sell_return_table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									@if($sell_line->quantity==100000000000)
									{{ $sell_line->formatted_qty }} {{$unit_name}}
									@endif
								</td>
