            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    @if(auth()->user()->can('accounting.manage_accounts'))
                        ...
                        <li @if(request()->segment(2) == 'chart-of-account') class="active" @endif><a href="{{action([\Modules\Accounting\Http\Controllers\CoaController::class, 'indexajax'])}}">@lang('accounting::lang.chart_of_accounts')<small><span class="label text-success">جديد</span></small></a></li>
                    ...
                    <li @if(request()->segment(2) == 'opening-jornal-entry') class="active" @endif><a href="{{action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'createOpening'])}}">قيد افتتاحي</a></li>
                    @endif
