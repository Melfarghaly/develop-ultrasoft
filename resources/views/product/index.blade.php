        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('category_id', __('product.more_categories') . ':') !!}
                            {!! Form::select('category_id', $categories, null, [
                                'class' => 'form-control select2','multiple',
                                'style' => 'width:100%',
                                'id' => 'product_list_filter_categories_ids',
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#product_list_filter_type,#product_list_filter_categories_ids, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id',
                function() {
