	    	...
	    	<div class="row">
							...
							@foreach($ingredient_groups as $ingredient_group)
								...
								@foreach($ingredient_group as $ingredient)
									<tr>
										...
										<td><span class="display_currency" data-currency_symbol="true">
										@can('manufacturing.prduction_cost')
											{{$ingredient['quantity']*$ingredient['dpp_inc_tax']*$ingredient['multiplier']}}
										@endcan
										</span></td>
									</tr>
								@endforeach
      		...
      		<div class="row">
      			...
      			<div class="col-md-6">
      				...
      				<span class="display_currency">{{@num_format($recipe->extra_cost)}} @if($recipe->production_cost_type == 'percentage') % @elseif ($recipe->production_cost_type == 'per_unit') (@lang('manufacturing::lang.per_unit')) @endif </span ><br>
