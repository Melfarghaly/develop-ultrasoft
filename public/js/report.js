$(document).ready(function() {
    ...
    var stock_report_cols = [
            ...
            stock_report_cols.push({ data: 'base_unit', name: 'base_unit', searchable: false });
       
            stock_report_cols.push({ data: 'sub_unit_1', name: 'sub_unit_1', searchable:false});
            stock_report_cols.push({ data: 'sub_unit_2', name: 'sub_unit_2',searchable:false});
    ...
    stock_report_table = $('#stock_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.qty_status = $('#qty_status').val();
                d.sub_category_id = $('#sub_category_id').val();
                d.brand_id = $('#brand').val();
                d.unit_id = $('#unit').val();
                d.categories_ids = $('#product_list_filter_categories_ids').val();
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            for (var r in data){
                debugger;
                footer_total_stock += $(data[r].base_unit).data('orig-value') ? 
                parseFloat($(data[r].base_unit).data('orig-value')) : 0;
            ...
            $('.footer_total_stock').html(footer_total_stock);
    ...
    $('#stock_report_filter_form #location_id,#qty_status,#product_list_filter_categories_ids,#product_list_filter_sub_unit_id, #stock_report_filter_form #category_id, #stock_report_filter_form #sub_category_id, #stock_report_filter_form #brand, #stock_report_filter_form #unit,#stock_report_filter_form #view_stock_filter'
    ).change(function() {
