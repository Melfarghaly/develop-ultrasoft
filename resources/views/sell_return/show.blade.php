...
<div class="modal-body">
   <div class="row">
    ...
    <!-- cost center -->
    @if(!empty($sell->return_parent->cost_center))
      <div class="row">
        <div class="col-sm-6 col-xs-6 btn-info">
          <strong>@lang('lang_v1.cost_center'):</strong> {{ $sell->return_parent->cost_center->name  }}
        </div>
      </div>
    @endif
    <br>
        ...
        <tbody>
            @php
              ...
              if(empty($sell->sell_lines)){
                $sell->sell_lines = $sell->return_parent->sell_lines;
              }
            @endphp
