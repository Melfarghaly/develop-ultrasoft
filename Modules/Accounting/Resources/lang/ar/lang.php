...
return [
    ...
    "transfer_balance"=>'ترحيل أرصدة',
    "to_year"=>"إلي سنة",
    "from_year"=>"من سنة",
    'discount_account'=>'حساب الخصم',
    'tax_account'=>'حساب الضريبة',
    'supplier_parent_account'=>'اضافة الموردين تحت حساب ',
    'customer_parent_account'=>'اضافة العملاء تحت حساب',
    'default_cash_account_id'=>'خزنة الكاش الافتراضي',
    'parent_bank_account_id'=>'الحساب الاب للخزن  ',
