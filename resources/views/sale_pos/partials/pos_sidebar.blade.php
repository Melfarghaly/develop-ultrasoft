...
<div class="row">
    ...
    <div class="col-md-4">
        <ul class="list-group " id="product_list_body_filter" style=" max-height: 485px; overflow-y: scroll;">
            @foreach($categories as $category)
                <li class="list-group-item --tw-gradient-from-t  tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 hover:tw-from-indigo-600 hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer">	
                    <a href="#" class="main-category-filter text-white text-center text-lg" data-value="{{ $category['id'] }}" data-parent="0">{{$category['name']}}</a>
