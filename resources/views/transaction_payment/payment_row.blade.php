      ...
      <div class="row payment_row">
        <div class="col-md-4">
          <div class="form-group">
            {!! Form::label("method" , __('purchase.payment_method') . ':*') !!}AA
          ...
          @endphp
              ...
              <div class="col-md-6 bank-selection">
                <div class="form-group">
                        ...
                        {!! Form::select("bank_account_id", $banks, !empty($payment_line->accounting_account_id) ? $payment_line->accounting_account_id : '' , ['class' => 'form-control select2', 'id' => "accounting_account_id", 'style' => 'width:100%;']); !!}
                ...
                <div class="form-group">
                  ...
                  {!! Form::select("cash_account_id", $cashAccounts, !empty($payment_line->accounting_account_id) ? $payment_line->accounting_account_id : '' , ['class' => 'form-control select2', 'id' => "accounting_account_id", 'style' => 'width:100%;']); !!}
