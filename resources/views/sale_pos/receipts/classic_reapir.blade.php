...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-12 text-center">
        ...
        <div class="col-xs-6 text-right">
            <b>{{$receipt_details->date_label}}</b> <span class="bordered">{{$receipt_details->invoice_date}}</span>
            ...
            @if(!empty($receipt_details->invoice_no_prefix))
				...
				<span class="bordered">{{$receipt_details->invoice_no}}</span>
        ...
        <div class="row">
            ...
            <div class="col-xs-5 text-left">
                    ...
                    @endif
                    @if(!empty($receipt_details->repair_custom_field1))
                    رقم السيارة:
                    {{$receipt_details->repair_custom_field1}}
                    <br>
                    @endif
                    @if(!empty($receipt_details->repair_job_sheet_date))
                    تاريخ الاستلام :
                    {{$receipt_details->repair_job_sheet_date}}
                    <br>
                    @endif
