        ...
        <div class="row">            
            ...
            <div class="col-md-4 mt-15">
                <label class="radio-inline">
                    <input type="radio" checked name="contact_type_radio" id="inlineRadio1" value="">
                    @lang('lang_v1.')
                </label>
                <label class="radio-inline">
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                  {!! Form::label('sell', __('lang_v1.selling_price_group') . ':') !!}
                  <div class="input-group">
                      <span class="input-group-addon">
                          <i class="fa fa-users"></i>
                      </span>
                      @php 
                      $price_groups=\App\SellingPriceGroup::forDropdown(auth()->user()->business_id);
                      @endphp
                      {!! Form::select('price_group_id', $price_groups, '', ['class' => 'form-control']); !!}
                  </div>
                </div>
            </div>
            <div class="clearfix customer_field"></div>
