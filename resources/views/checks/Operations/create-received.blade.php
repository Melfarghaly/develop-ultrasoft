@extends('layouts.app')
@section('title', __('general_accounts.create_received_check'))
@section('content')
            ...
            <div class="container mt-5">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label">عدد الشيكات الوارد</label>
                        <input type="text" class="form-control"
                            value="{{ session('issuedCheckCount', max(1, $receivedCheckCount)) }}" readonly>
                    </div>
