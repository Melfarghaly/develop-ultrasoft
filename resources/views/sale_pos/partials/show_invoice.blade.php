...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-right mb-12" >
            ...
            <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white no-print tw-dw-btn-sm" id="print_invoice_table" 
                 aria-label="Print"><i class="fas fa-print"></i> طباعة جدول المنتجات
            </button>
            @auth
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click', '#print_invoice_table', function(){
            $('#product-table-invoie').printThis();
        });
    });
