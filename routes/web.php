...
use App\Http\Controllers\CombinedSellReturnController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/contacts-sync-accounts', [ContactController::class, 'syncContacts']);
    ...
    Route::get('/products/add-selling-price-goup/{id}', [ProductController::class, 'addSellingPriceGroup']);
    ...
    Route::get('/purchases/add-opening-stock', [PurchaseController::class, 'openingStock']);
    ...
    Route::get('/reports/stock-price-groups', [ReportController::class, 'stockPriceGroups']);
    Route::post('/reports/update-sell-price', [ReportController::class, 'updateSellPrice'])->name('updateSellPrice');
    ...
    Route::get('/reports/product-sell-report-eta', [ReportController::class, 'getproductSellReportEta']);
    ...
    Route::prefix('companies')->name('companies.')->group(function () {
        ...
        Route::post('/attach-payment-method', [CompanyController::class, 'attachPaymentMethod'])
            ->name('attach-payment-method');

        // Add this new route
        Route::get('/{company}/payment-methods', [CompanyController::class, 'getPaymentMethods'])
    ...
    Route::post('/import-opening-stock/storeOpeningStock', [ImportOpeningStockController::class, 'storeOpeningStock']);
    ...
    Route::get('/sell-return/create', [CombinedSellReturnController::class, 'create']);
    Route::get('/sell-return/edit/{id}', [CombinedSellReturnController::class, 'edit']);
    Route::post('/sell-return/update/{id}', [CombinedSellReturnController::class, 'update']);
    Route::post('/sell-return/save', [CombinedSellReturnController::class, 'save']);
    ...
    Route::post('cost-center/store', [CostCenterController::class, 'store'])->name('cost-center.store');
    Route::get('cost-center/edit/{id}', [CostCenterController::class, 'edit'])->name('cost-center.edit');
    Route::get('cost-center/ledger', [CostCenterController::class, 'show'])->name('cost-center.ledger'); 
    Route::get('cost-centers-dropdown', [CostCenterController::class, 'dropdown'])->name('cost-centers-dropdown');
   // Route::put('cost-center/update/{id}', [CostCenterController::class, 'update'])->name('cost-center.update');
    Route::delete('cost-center/destroy/{id}', [CostCenterController::class, 'destroy'])->name('cost-center.destroy');

    Route::put('/cost-center/{id}', 'CostCenterController@update')->name('cost-center.update');
    ...
    Route::prefix('checks')->name('checks.')->group(function () {
        ...
        Route::get('{id}/print', [CheckController::class, 'print'])->name('print');
        Route::put('{id}', [CheckController::class, 'update'])->name('update');
        Route::get('issued/create', [CheckController::class, 'createIssued'])->name('create.issued');
        Route::get('received/create', [CheckController::class, 'createReceived'])->name('create.received');
        Route::post('issued', [CheckController::class, 'storeIssued'])->name('store.issued');
        Route::post('received', [CheckController::class, 'storeReceived'])->name('store.received');
        Route::delete('{id}', [CheckController::class, 'destroy'])->name('destroy');
        Route::get('{id}/edit', [CheckController::class, 'edit'])->name('edit');
        Route::get('/syncChecks', [VoucherController::class, 'syncChecks'])->name('syncChecks');
    });

    Route::prefix('check-transactions')->name('checks.')->group(function () {
        Route::get('/', [CheckTransactionController::class, 'index'])->name('movementChecks');
        Route::post('/save', [CheckTransactionController::class, 'save'])->name('save');
        Route::get('/report', [CheckTransactionController::class, 'report'])->name('report');
        Route::delete('{id}', [CheckTransactionController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('vouchers')->name('vouchers.')->group(function () { 
        ...
        Route::get('create/cash_disbursement', [VoucherController::class, 'createCashDisbursement'])->name('create.cash_disbursement');
        Route::post('store/cash_disbursement', [VoucherController::class, 'storeCashDisbursement'])->name('store.cash_disbursement');
        Route::get('create/cash_receipt', [VoucherController::class, 'createCashReceipt'])->name('create.cash_receipt');
        Route::post('store/cash_receipt', [VoucherController::class, 'storeCashReceipt'])->name('store.cash_receipt');
        Route::get('{voucher}/edit', [VoucherController::class, 'edit'])->name('edit');
        Route::put('{voucher}', [VoucherController::class, 'update'])->name('update');
        Route::delete('{voucher}', [VoucherController::class, 'destroy'])->name('destroy');
        Route::get('{voucher}/print', [VoucherController::class, 'print'])->name('print');
        Route::get('syncVoucher', [VoucherController::class, 'syncVoucher'])->name('syncVoucher');
        
        Route::get('/dashboard', [VoucherController::class, 'dashboard'])->name('dashboard');
    });
    ...
    Route::get('cash_transactions/{cashTransaction}/edit/{actionType?}', [CashTransactionController::class, 'edit'])->name('cash_transactions.edit');
    Route::get('cash_transactions/{cashTransaction}/print', [CashTransactionController::class, 'print'])->name('cash_transactions.print');

    Route::prefix('cash_deposits')->name('cash_deposits.')->group(function () {
        Route::get('create', [CashTransactionController::class, 'createDeposit'])->name('create');
        Route::post('/', [CashTransactionController::class, 'storeDeposit'])->name('store');
    });

    Route::prefix('cash_withdrawals')->name('cash_withdrawals.')->group(function () {
        Route::get('/', [CashTransactionController::class, 'index'])->name('index');
        Route::get('create', [CashTransactionController::class, 'createWithdrawal'])->name('create');
        Route::post('store', [CashTransactionController::class, 'storeWithdrawal'])->name('store');
    });
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    Route::prefix('checks')->name('checks.')->group(function () {
        ...
        Route::post('issued', [CheckController::class, 'storeIssued'])->name('store.issued');
        Route::post('received', [CheckController::class, 'storeReceived'])->name('store.received');
        Route::delete('{id}', [CheckController::class, 'destroy'])->name('checks.destroy');
        Route::get('{id}/edit', [CheckController::class, 'edit'])->name('edit');
        Route::get('/accounting/banks-dropdown', [CheckController::class, 'banksDropdown']);
    });
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    Route::prefix('vouchers')->name('vouchers.')->group(function () {
        Route::get('/', [VoucherController::class, 'index'])->name('index');
        Route::get('/report', [VoucherController::class, 'report'])->name('report');
        Route::get('/print-report', [VoucherController::class, 'printReport'])->name('printReport');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // New route for bank transactions report
    Route::get('bank_transactions_sreport', [CashTransactionController::class, 'report'])->name('cash_transactions.report');
    Route::get('bank_transactions_sreport/print_report', [CashTransactionController::class, 'printReport'])->name('print_report');
