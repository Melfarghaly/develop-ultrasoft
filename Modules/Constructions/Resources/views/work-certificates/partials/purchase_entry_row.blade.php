@foreach( $variations as $variation)
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        ...
        <td>
            {!! Form::textarea('purchases[' . $row_count . '][description]', null, ['class' => 'form-control input-sm purchase_description ', 'required']); !!}
        </td>
        <td>
        ...
        <td>
            {!! Form::text('purchases[' . $row_count . '][unit_text]', null, ['class' => 'form-control input-sm purchase_unit_text ', 'required']); !!}
        </td>
        <td>
            @php
        ...
        <td>
            {!! Form::text('purchases[' . $row_count . '][implementation_rate]', null, ['class' => 'form-control input-sm purchase_implementation_rate input_number', 'required']); !!}
        </td>
        <td>
