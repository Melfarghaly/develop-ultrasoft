    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase.permission', in_array('purchase.permission', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'purchase.permission' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('permissions[]', 'sell.permission', in_array('sell.permission', $role_permissions), 
                        [ 'class' => 'input-icheck']); !!} {{ __( 'sale.permission' ) }}
                      </label>
                    </div>
                </div>
      ...
      <hr>
        ...
        <div class="row check_group">
        <div class="col-md-1">
          <h4>@lang( 'report.stock_report' )</h4>
        </div>
        <div class="col-md-2">
            <div class="checkbox">
              <label>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock.costprice', in_array('stock.costprice', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.stock_report_cost_price' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock.sellprice', in_array('stock.sellprice', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.stock_report_sell_price' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock.withoutpirce', in_array('stock.withoutpirce', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.stock_report_withoutprice' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="row check_group">
            <div class="col-md-1">
                <h4>@lang('general_accounts.general_accounts')</h4>
            </div>
            <div class="col-md-2">
                <div class="checkbox">
                    <label>
            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'access_checks', in_array('access_checks', $role_permissions), 
                            ['class' => 'input-icheck']) !!} {{ __('general_accounts.access_checks') }}
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'access_vouchers', in_array('access_vouchers', $role_permissions), 
                            ['class' => 'input-icheck']) !!} {{ __('general_accounts.access_vouchers') }}
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'access_cash_transactions', in_array('access_cash_transactions', $role_permissions), 
                            ['class' => 'input-icheck']) !!} {{ __('general_accounts.access_cash_transactions') }}
                        </label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'view_reports', in_array('view_reports', $role_permissions), 
                            ['class' => 'input-icheck']) !!} {{ __('general_accounts.view_reports') }}
                        </label>
                    </div>
                </div>
            </div>
