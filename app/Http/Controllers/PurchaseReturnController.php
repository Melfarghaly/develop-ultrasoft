...
class PurchaseReturnController extends Controller
{
     ...
     * @return void
     */
    public function __construct(TransactionUtil $transactionUtil, ProductUtil $productUtil, AccountingUtil $accountingUtil)
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if (! empty(request()->cost_center_id)) {
                $purchases_returns->where('transactions.cost_center_id', request()->cost_center_id);
            }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (! empty($return_transaction)) {
                ...
                $return_transaction_data['cost_center_id'] = $request->input('cost_center_id');
            ...
            event(new PurchaseReturnAdded($return_transaction));
            DB::commit();
        } catch (\Exception $e) {
            DB::rollBack();
