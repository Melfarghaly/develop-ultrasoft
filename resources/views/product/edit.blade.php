...
{!! Form::open(['url' => action([\App\Http\Controllers\ProductController::class, 'update'] , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('sku', __('egscode') . ':') !!} 
                {!! Form::text('egscode', $product->egscode, ['class' => 'form-control',
                'placeholder' => __('egscode')]); !!}
            </div>
          </div>
            ...
            <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
              <div class="form-group">
                {!! Form::label('categories_ids', __('product.more_categories') . ':') !!}
                  {!! Form::select('categories_ids[]', $categories, json_decode($product->categories_ids), ['multiple', 'class' => 'form-control select2']); !!}
              </div>
            </div>
