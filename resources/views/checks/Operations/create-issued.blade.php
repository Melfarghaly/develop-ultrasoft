@extends('layouts.app')
@section('title', __('general_accounts.create_issued_check'))
@section('content')
                ...
                <div class="row mb-3">
                   ...
                   @endphp
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select id="bank" name="bank_id" class="form-control  @error('bank') is-invalid @enderror">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <div class='input-group ' id='datetimepick'>
                            <input type="text" id="issue_date" name="issue_date"
                                class="form-control @error('issue_date') is-invalid @enderror datepicker_now"
                             >
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <div class='input-group ' id=''>
                            <input type="text" id="due_date" name="due_date"
                                class="form-control @error('due_date') is-invalid @enderror datepicker_due"
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('.datepicker_now').datetimepicker({
                format: moment_date_format ,
                ignoreReadonly: true,
            });
            $('.datepicker_due').datetimepicker({
                format: moment_date_format ,
                ignoreReadonly: true,
            });
            $('.datepicker_now').val(moment().format(moment_date_format));
        })
