...
@php 
$uitl=new \App\Utils\Util();
@endphp
<div class="col-xs-12" style="">
    <img class="watermark" src="/uploads/business_logos/{{$receipt_details->business->logo}}"> 
</div>
	...
	<div class="col-xs-8 text-center hide">
		<!-- Invoice  number, Date  -->
				...
				<table class="table customer-table">
					<tr>
						<td class="border-left">
							<span class="pull-right">تاريخ الاصدار </span>
							<span class="pull-center"> {!!$receipt_details->invoice_date!!}</span>
							<span class="pull-left"> Issue Date</span>
						</td>
						<td>
							<span class="pull-right"> الرقم الضريبي  للعميل  </span>
							<span class="pull-center"> {!!$receipt_details->customer_tax_number !!}</span>
							<span class="pull-left"> VatNoCust</span>
						</td>
					</tr>
					<tr>
						<td class="border-left">
							<span class="pull-right">رقم الفاتورة  </span>
							<span class="pull-center"> {!!$receipt_details->invoice_no !!}</span>
							<span class="pull-left"> Inoivce NO</span>
						</td>
						<td>
							<span class="pull-right"> رقم جوال العميل     </span>
							<span class="pull-center"> {!!$receipt_details->customer_mobile !!}</span>
							<span class="pull-left"> Customer No</span>
						</td>
					</tr>
					<tr>
						<td class="border-left" style="border-bottom:0px ">
							<span class="pull-right">تاريخ الاستحقاق   </span>
							<span class="pull-center"> </span>
							<span class="pull-left"> Date Due</span>
						</td>
						<td style="border-bottom:0px ">
							<span class="pull-right"> رقم  أمر الشراء     </span>
							<span class="pull-center"> </span>
							<span class="pull-left">  P.O. No</span>
						</td>
					</tr>
				</table>
			</div>
			<br>
			<div class="customer" style="background: #d3d3d3;">
				<table class="table customer-table" style="background: #d3d3d3;">
					<tr>
						<td style="border-bottom:0px ">
							<span class="pull-right"> اسم العميل      </span>
							<span class="pull-center"> {{$receipt_details->customer_name}}</span>
		...
		<table class="table table-responsive table-slim product_table">
			<thead>
				...
				<tr>
					...
					<th class="text-center" width="15%">الوحدة></th>
				...
				@forelse($receipt_details->lines as $k=> $line)
					<tr>
						...
						<td>
							...
							@php 
							$line_taxes+=$line['tax_unformatted'] ;
							$line_discounts+=$line['line_discount_uf'];
							@endphp
						</td>
						@if(!empty($receipt_details->discounted_unit_price_label))
							<td class="text-right">
...
<div class="row">
	...
	<br>
			<div class="customer">
				<table class="table customer-table total_table">
					<tr>
						<td class="">
						المجموع قبل الضريبة
						</td>
						<td class="pull-center"> Total VAT.Excl</td>
						<td> {!!$receipt_details->subtotal_exc_tax!!}</td>
					<tr>
						
							<td> الخصم </td>
							<td class="pull-center">Discount</td>
							<td> {!!$receipt_details->discount + $line_discounts !!}</td>
						</td>
					</tr>
					<tr>
						
							<td> ضريبة القيمة المضافة  </td>
							<td class="pull-center"> VAT(15%)</td>
							<td > {!!$receipt_details->tax_uf + $line_taxes !!}</td>
					</tr>
					<tr>
						
							<td> الاجمالي النهائي    </td>
							<td class="pull-center"> Balance Due</td>
							<td > {!! $receipt_details->total !!}
					...
					<tr>
							...
							<td>   المدفوع   </td>
							<td class="pull-center"> Paid in cash</td>
							<td > {!! $receipt_details->total_paid !!}
...
<div class="row hide" style="color: #000000 !important; hide">
