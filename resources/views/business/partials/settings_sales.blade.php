<div class="pos-tab-content">
    ...
    <div class="row"> 
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('cmmsn_calculation_type', __('lang_v1.sales_commission_agent') . ':تسمية ') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
                    {!! Form::text('pos_settings[cmmsn_name_field]',  !empty($pos_settings['cmmsn_name_field']) ? $pos_settings['cmmsn_name_field'] : null, ['class' => 'form-control ', 'style' => 'width: 100%;', 'id' => 'cmmsn_name_field']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-4">
