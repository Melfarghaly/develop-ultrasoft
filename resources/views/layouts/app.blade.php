...
<head>
    ...
    @yield('css')
    <link rel="stylesheet" href="/css/ultrasoft.css">
    @if($pos_layout)
        <link rel="stylesheet" href="/css/pos.css">
        <style>
            .pos-form-actions{
                background-color:  #ef7d23 !important;
                background: linear-gradient(to top, #ef7d23, #ef7d23) !important;
            }
            ...
            body{
                ...
                background: linear-gradient(to left, #f5f5f5, #f5f5f5) !important;
            }
            .tw-bg-gray-100 {
                --tw-bg-opacity: 1;
            ...
            .tw-to-blue-500{
                background: #ef7d23 !important;
            }
            thead {
               
                background: linear-gradient(to top, orange, #ef7d23);
                color: white;
                font-weight: bold;
            }
