@extends('layouts.app')
@section('title', __('constructions::lang.edit_work_certificate'))
...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('constructions::lang.edit_work_certificate') 
    @if($type=='permission')
...
<section class="content">
  ...
  {!! Form::open(['url' =>  route('constructions.work-certificates.update', [$purchase->id]), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-md-3">
              @includeIf('cost_center.costCenter', [ 'selected_cost_center' => $purchase->cost_center_id])
            </div>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            <div class="col-sm-12">
              @include('constructions::work-certificates.partials.edit_purchase_entry_row')
    ...
    @endcomponent
<div class="@if($type=='permission') hide @endif">
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            <div class="col-sm-12">
                <table class="table">
