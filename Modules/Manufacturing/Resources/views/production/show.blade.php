<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button id="togglePricesBtn" class="btn btn-primary btn-xs no-print">اخفاء الاسعار</button>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="price-cell">@lang('manufacturing::lang.total_price')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            @foreach($ingredients as $ingredient)
                                <tr>
                                    ...
                                    @endphp
                                    <td class="price-cell">
                                        @can('manufacturing.prduction_cost')
                        ...
                        <tfoot>
                            @can('manufacturing.prduction_cost')
                            <tr>
                                <td class="price-cell" colspan="4" class="text-right"><strong>@lang('manufacturing::lang.ingredients_cost')</strong></td>
                                <td class="price-cell"><span class="display_currency" data-currency_symbol="true">{{$total_ingredient_price}}</span></td>
                            </tr>
                            
                            <tr>
                                <td class="price-cell" colspan="4" class="text-right"><strong>{{__('manufacturing::lang.production_cost')}}:</strong></td>
                                <td class="price-cell"><span class="display_currency" data-currency_symbol="true">{{$total_production_cost}}</span> </td>
                            </tr>
                            <tr><td class="price-cell" colspan="4" class="text-right"><strong>{{__('manufacturing::lang.total_cost')}}:</strong></td>
                                <td class="price-cell"><span class="display_currency" data-currency_symbol="true">{{$production_purchase->final_total}}</span></td>
                            </tr>
                            @endcan
                        </tfoot>
                    </table>
...
<script>
    if(typeof togglePricesBtn !== 'undefined') {
