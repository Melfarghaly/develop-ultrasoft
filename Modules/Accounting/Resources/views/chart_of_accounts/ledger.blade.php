            ...
            <div class="box box-solid">
                <div class="box-body">
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <th>اجمالي الرصيد - شامل الابناء</th>
                            <td>
        ...
        <div class="col-md-7">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-4"><!--class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2"-->
                    <button type="button" class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2 " id="exampleModal_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
@stop
@include('accounting::partials.transfer_balance',['account_id'=>$account->id])
@section('javascript')
    ...
    $(document).ready(function(){        
        ...
        ledger = $('#ledger').DataTable({
                            ...
                            "footerCallback": function ( row, data, start, end, display ) {
                                ...
                                var bal=footer_total_debit-footer_total_credit;
                                if(bal<0){
                                    $('.footer_total_balance').html
                                    ('<span class="text-danger">CR '+__currency_trans_from_en(bal)+'</span>');
                                }else{
                                    $('.footer_total_balance').html
                                    ('<span class="text-success">DR '+__currency_trans_from_en(bal)+'</span>');
                                }
                            }
                        });
